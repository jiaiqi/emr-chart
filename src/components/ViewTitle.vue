<template>
  <div class="view_title">
    <div class="title_left">
      <div v-if="titleViewData.currentPage === 'secplat'" class="header_left">
    ...
    <div class="title_right">
      ...
      <div class="account_info">
        ...
        <span class="user_no">
          {{
          user !== null && user.user_no !== null ? user.user_no : "-"
          }}
        </span>
      </div>
...
export default {
  ...
  methods: {
    ...
    regNumTimeOuts() {
      let self = this;
      self.regNumTimeOut = new this.timeOut(300, 0, self.RegNum);
      self.regNumTimeOut.reqFun();
      self.regNumTimeOut.startTime();
    },
    usernoTimeOuts() {
      let self = this;
      self.usernoTimeOut = new this.timeOut(300, 0, self.getData_userno);
