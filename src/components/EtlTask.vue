      ...
      <div class="content_right_content ">
        <div class="tab_content">
          ...
          <div class="databox_three">
            ...
            <div class="gantt_task">
              <span @click="checkTask(item)" v-for="(item,index) in taskName" :key="index">{{item.job_name}}</span>
            </div>
            <div class="databox_three_content">
              ...
              <div style="text-align:center;padding:5rem 0;" v-if="!this.GanttData.length">
               ~ 暂无数据 ~
              </div>
...
    }
    ...
    getChartData(e){
      ...
      if(e==='day'){
          ...
          for (let i = 1; i <= 24; i++) {
            ...
            xTitle.push(moment().subtract(24 - i, 'hours').format('HH')+'点')
          ...
          let xTitle = []
          for (let i = 1; i <= 7; i++) {
            xTitle.push(moment().subtract(7 - i, 'weeks').format('YYYY-MM-DD'))
          ...
          let xTitle = []
          for (let i = 1; i <= 30; i++) {
          xTitle.push(moment().subtract(30 - i, 'days').format('MM-DD'))
        }
          xTitle.map((item) => {
            let rowItem = {
          ...
          let xTitle = []
          for (let i = 1; i <= 12; i++) {
          xTitle.push(moment().subtract(12 - i, 'month').format('YYYY-MM'))
        }
          xTitle.map((item) => {
            let rowItem = {
    ...
    getNewTask(str){
      ...
      let url = this.getServiceUrl("select", params.serviceName, "datacenter")
        ...
        .then(res => {
            ...
            console.error('GanttData',GanttData)
  ...
  updated(){
    ...
    console.log(this.checkDataType)
  },
  mounted() {
    this.getRightTask()
    setTimeout(()=>{
...
@media screen and (max-width: 1366px) {
      ...
      .databox_three .databox_three_contentheader > .databox-col, .databox_three .databox-three-contentdata-view > .databox-col{
