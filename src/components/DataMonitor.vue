...
export default {
  ...
  methods: {
    ...
    ConvertStor(num) {
      // debugger;
      let nums = num * 1024;
      if (parseFloat(nums) < 1024) {
        nums = nums.toFixed(2) + "KB";
      } else if (nums >= 1024 && nums < 1024 * 1024) {
        nums = (nums / 1024).toFixed(2) + "MB";
      } else if (nums >= 1024 * 1024 && nums < 1024 * 1024 * 1024) {
        nums = (nums / 1024 / 1024).toFixed(2) + "GB";
      } else {
        nums = (nums / 1024 / 1024 / 1024).toFixed(2) + "TB";
      }
      return nums;
    },
  },
