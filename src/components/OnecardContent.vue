  ...
  <div class="onecard_content">
    <dv-border-box-10 class="content_left">
      <div class="content_left_box">
        <div
          v-if="contentData.currentPage === 'dataShare' && contentData.firstBar.data.rows.length > 0"
          class="content_left_left data-share-left"
        >
        ...
        <div v-if="contentData.currentPage !== 'dataShare'" class="content_left_left">
          <div class="big-title">{{ contentData.firstBar.title }}</div>
          <ve-histogram
            :data="contentData.firstBar.data"
            :settings="chartSetting"
        ...
        <div v-if="contentData.currentPage != 'dataShare'" class="content_left_right">
          ...
          <div class="content_left_right_item">
            ...
            <ve-pie
              ...
              v-if="
                ...
                isArray(contentData.secondPie.data.rows) &&
      ...
      <div class="databox_three" v-else-if="contentData.currentPage === 'ETL'">
        ...
        <div class="gantt_task">
          <span
            ...
            :key="index"
            :class="{ hos: contentData.secondBar.tableData.currentEtlIndex?contentData.secondBar.tableData.currentEtlIndex:Act == index }"
          >{{ item.job_name }}</span>
        </div>
