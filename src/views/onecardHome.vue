      ...
      <div class="icon-view">
        ...
        >
          ...
          <div class="content_header_divt">
            ...
            <span>
              {{
              item.value === null || item.value === "NaN"
              ? "0"
              : convert(item.value)
              }}
            </span>
  ...
  methods: {
    ...
    homeHref(item) {
      if (item == "卡机个数") {
        ...
        let endRequest = encodeURI(JSON.stringify(request));
        let page = {
          title: item,
          url:
            "/vpages/index.html#/list/srvcvs_medical_records_select?srvApp=cvs&operate_params=" +
            endRequest,
          icon: "",
        };
        window.top.tab.addTab(page);
        ...
        let zy_endRequest = encodeURI(JSON.stringify(zy_request));
        let page = {
          title: item,
          url:
            "/vpages/index.html#/list/srvcvs_medical_records_select?srvApp=cvs&operate_params=" +
    ...
    development(item) {
      if (item == "患者就诊卡总数") {
        ...
        let page = {
          title: item,
          url: "/vpages/index.html#/list/DI_ADI_LAREXA_INFO_select?srvApp=emr",
          icon: "",
        };
        window.top.tab.addTab(page);
        // window.location.href = '/vpages/index.html#/list/DI_HDI_INRECORD_INFO_select'
        ...
        let page = {
          title: item,
          url: "/vpages/index.html#/list/DI_HDI_LAREXA_INFO_select?srvApp=emr",
          icon: "",
        };
        window.top.tab.addTab(page);
        // window.location.href = '/vpages/index.html#/list/DI_HDI_INRECORD_INFO_select'
