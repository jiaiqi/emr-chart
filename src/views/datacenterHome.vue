...
export default {
    ...
    methods: {
        ...
        getData_five() {
            ...
            let path = this.getServiceUrl("select", 'srvetl_job_select', "datacenter");
            axios.post(
                path, req5,
            ).then(res => {
        ...
        getData_six() {
            ...
            let path = this.getServiceUrl("select", 'srvetl_job_history_select', "datacenter");
            axios.post(
                path, req6,
            ).then(res => {
        ...
        getData_seven() {
            ...
            let path = this.getServiceUrl("select", 'srvetl_processor_history_select', "datacenter");
            axios.post(
                path, req7,
            ).then(res => {
