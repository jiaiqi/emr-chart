...
export default {
  ...
  methods: {
    ...
    viewtabs(pageName) {
      ...
      this.refreshRuntime() // 启动运行时间的定时刷新
      this.refreshChartData() // 启动图表数据的定时刷新
    },
    ...
    refreshChartData() {
      this.refresh.chartData = new this.timeOut(30, 0, this.getAlldata)
      this.refresh.chartData.reqFun()
      this.refresh.chartData.startTime()
    },
  },
  data() {
    return {
