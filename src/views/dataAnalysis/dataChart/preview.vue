    ...
    getPreviewTableData () {
      ...
      this.axios
        ...
        .then(res => {
          ...
          let tableTitle = []
          console.log("TCL: getPreviewTableData -> tableAllTitleData", tableAllTitleData)
          ...
          console.log('TCL: getPreviewTableData -> title:', tableTitle)
          //表格内容数据
        })
        .catch(err => {
          console.log(err);
      ...
      if (this.chartNumber) {
        ...
        this.axios.post(url, params)
          .then(res => {
            ...
            console.log("TCL: getChartConfig -> res.data.data", res.data.data)
            this.$nextTick(function () {
              this.chartconfig = data
              console.log("TCL: getChartConfig -> data", data)
              console.log("TCL: getChartConfig -> this.chartconfig", this.chartconfig)
            })
            if (data.length >= 0) {
              data = data[0]
          ...
          this.axios
            ...
            .then(res => {
              ...
              if (data.state === "SUCCESS") {
                ...
                console.log("datas:保存成功", data);
              } else {
                console.log("datas:保存失败", data);
              }
            })
            .catch(err => {
              console.error(err);
